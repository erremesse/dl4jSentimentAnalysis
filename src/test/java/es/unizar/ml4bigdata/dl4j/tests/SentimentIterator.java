...
//        File p = new File(FilenameUtils.concat(dataDirectory, "data/" + (train ? "train" : "test") + "/pos/") + "/");
//        File n = new File(FilenameUtils.concat(dataDirectory, "data/" + (train ? "train" : "test") + "/neg/") + "/");
        File p = new File(FilenameUtils.concat(dataDirectory, (train ? "train" : "test2") + "/pos/") + "/");
      File n = new File(FilenameUtils.concat(dataDirectory, (train ? "train" : "test2") + "/neg/") + "/");
